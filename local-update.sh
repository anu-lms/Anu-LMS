...
# Set the right permis for the public key.
docker-compose exec php sh -c "sudo chmod 660 keys/public.key"
docker-compose exec php sh -c "sudo chown 82:82 keys/public.key"
